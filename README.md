[![Build Status](https://travis-ci.org/bootcamp-joinville/katas-part-one-salazenas.svg?branch=master)](https://travis-ci.org/bootcamp-joinville/katas-part-one-salazenas)
